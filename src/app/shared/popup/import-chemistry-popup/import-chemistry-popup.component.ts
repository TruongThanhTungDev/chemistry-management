...
@Component({
  selector: 'import-chemistry-popup',
  templateUrl: './import-chemistry-popup.component.html',
  styleUrls: ['import-chemistry-popup.component.scss'],
})
export class ImportChemistryPopup {
  @Input() title?: string;
  readonly #modal = inject(NzModalRef);
  readonly nzModalData = inject(NZ_MODAL_DATA);
  UPLOAD_FILE_URL = 'api/v1/Chemiscal/upload';
  listChemistry: any[] = [];
  selectedFile: any;
  isLoading = false;
